 ...
 * of that class can be used interchangeably with others that also implement
 ...
 * In the US there are three prongs and AC current. Tons of different electrical
 * devices are able to receive power and do various jobs by virtue of conforming
 * to this standard interface for receiving power as in input.
 * 
 * Similarly, in our application, as long as each effect like Border or Brightness
 * adheres to the same interface, we can use effects interchangeably in
